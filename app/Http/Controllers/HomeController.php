...
class HomeController extends Controller
{
    public function index()
    {
        ...
        $second = ProductDetail::GetProductDetailByCollection(Collection::getFirstBannerName());
        $first = ProductDetail::GetProductDetailByCollection(Collection::getSecondBannerName());
